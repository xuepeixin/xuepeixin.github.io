...
<center>
    <img
    src="https://raw.githubusercontent.com/xjxpx/xjxpx.github.io/master/img/2020/03/transform-view.png">
</center>
将相机移动到这样的位置分为两个步骤：
1. 将相机平移到原点
...
<center>
    <img
    src="https://raw.githubusercontent.com/xjxpx/xjxpx.github.io/master/img/2020/03/transform-differentview.png">
</center>
...
<center>
    <img
    src="https://raw.githubusercontent.com/xjxpx/xjxpx.github.io/master/img/2020/03/transform-orthographic.png">
</center>
...
<center>
    <img
    src="https://raw.githubusercontent.com/xjxpx/xjxpx.github.io/master/img/2020/03/transform-perspective.png">
</center>
透视投影同样需要两个步骤，
...
2. 使用正交投影的方法将长方体变换成标准立方体
  ...
  <center>
    <img
    src="https://raw.githubusercontent.com/xjxpx/xjxpx.github.io/master/img/2020/03/transform-perspective1.png">
  </center>
...
最终我们得到z轴的变化为$-\frac{2nf}{n+f}$，当n和f为正数时，变化量为负数，当n和f为负数时，变化量为正数。结合下面这样图可以发现压缩之后的点在z轴上总是会靠近原点，即$\{x,y,\frac{n+f}{2},1\}$所在平面上的点在压缩的时候z轴也被向里压缩了。
<center>
    <img
    src="https://raw.githubusercontent.com/xjxpx/xjxpx.github.io/master/img/2020/03/transform-perspective.png">
</center>
